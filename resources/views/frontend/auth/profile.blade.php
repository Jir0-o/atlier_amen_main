                                        ...
                                        <div class="p-4">
                                            ...
                                            <div class="pt-3">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <select id="shipping-country" name="country" class="form-control">
                                                        @php
                                                            $shipCountry = old('country', $user->shippingAddress->country ?? '');
                                                            $countries = [
                                                                ...
                                                                'Guyana','Haiti','Holy See (Vatican City State)','Honduras','Hong Kong','Hungary','Iceland',
                                                        ...
                                                        @foreach($countries as $country)
                                                            <option value="{{ $country }}" {{ $shipCountry === $country ? 'selected' : '' }}>
                                                                {{ $country }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <select id="billing-country" name="country" class="form-control">
                                                    @php
                                                        $billCountry = old('country', $user->billingAddress->country ?? '');
                                                        $countries = [
                                                            'Afghanistan','Albania','Algeria','American Samoa','Andorra','Angola','Anguilla',
                                                            'Antigua and Barbuda','Argentina','Armenia','Aruba','Australia','Austria','Azerbaijan',
                                                            'Bahamas','Bahrain','Bangladesh','Barbados','Belarus','Belgium','Belize','Benin','Bermuda',
                                                    ...
                                                    @foreach($countries as $country)
                                                        <option value="{{ $country }}" {{ $billCountry === $country ? 'selected' : '' }}>
                                                            {{ $country }}
                                                        </option>
                                                    @endforeach
                                                </select>
